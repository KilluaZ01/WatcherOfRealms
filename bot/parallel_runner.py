...
def run_batch(batch_num, start_guest_index, instances_per_batch, log_func, base_instance, guest_name_prefix, pause_event):
    ...
    steps = [
        ...
        ("Swipe!", swipe_macro, (702, 391, 830, 390), 5),
        ...
        ("Swipe!", swipe_macro, (1090, 645, 975, 200), 3),
        ("Swipe!", swipe_macro, (975, 200, 975, 290), 10),
        ("Swipe!", swipe_macro, (1210, 650, 850, 210), 3),
        ("Swipe!", swipe_macro, (850, 210, 850, 320), 80),
        ("Complete", tap_macro, (1130, 655), 15),
