...
def run_batch(batch_num, start_guest_index, instances_per_batch, log_func, base_instance, guest_name_prefix, pause_event):
    ...
    steps = [
        ...
        ("Swipe!", swipe_macro, (790, 385, 790, 275), 5),
        ...
        ("Swipe!", swipe_macro, (942, 391, 933, 252), 5),
        ("2x", tap_macro, (1220, 660), 3),
        ("Swipe!", swipe_macro, (1220, 652, 702, 391), 3),
        ("Swipe!", swipe_macro, (702, 391, 930, 308), 5),
        ("Swipe!", swipe_macro, (1220, 662, 804, 225), 3),
        ("Swipe!", swipe_macro, (804, 223, 823, 420), 3),
        ("2x", tap_macro, (1220, 660), 150),
        ("Complete", tap_macro, (1130, 655), 5),
        ("Complete", tap_macro, (1130, 655), 15),

        ("N1-7", tap_macro, (753, 414), 10),
        ("Fight", tap_macro, (1055, 675), 10),
        ("Start", tap_macro, (1145, 585), 15),
        ...
        ("N1-9", tap_macro, (911, 416), 5),
        ("Fight", tap_macro, (1055, 675), 10),
        ("Start", tap_macro, (1145, 585), 15),
        ("Swipe!", swipe_macro, (1100, 660, 475, 305), 3),
        ("Swipe!", swipe_macro, (475, 305, 779, 270), 3),
        ("Swipe!", swipe_macro, (1220, 645, 572, 500), 3),
        ("Swipe!", swipe_macro, (572, 500, 580, 250), 3),
        ("2x", tap_macro, (1160, 40), 5),
        ("Swipe!", swipe_macro, (1220, 645, 360, 225), 3),
        ("Swipe!", swipe_macro, (360, 225, 590, 215), 3),
        ("Swipe!", swipe_macro, (1220, 645, 325, 395), 3),
        ("Swipe!", swipe_macro, (325, 395, 670, 390), 80),
        ("Skip", tap_macro, (1210, 50), 8),
        ("Skip", tap_macro, (1210, 50), 8),

        ("Camp", tap_macro, (273, 662), 15),
        ("Summon", tap_macro, (800, 624), 10),
        ("Pull", tap_macro, (635, 595), 5),
        ("Pull", tap_macro, (635, 595), 15),
        ("Continue", tap_macro, (1140, 660), 8),
        ("Ok", tap_macro, (800, 617), 8),
        ("Back", tap_macro, (45, 30), 8),
        ("Heroes", tap_macro, (905, 625), 8),
        ("New Heroes", tap_macro, (60, 305), 8),
        ("Upgrade", tap_macro, (1045, 670), 10),
        ("Upgrade", tap_macro, (935, 575), 15),
        ("Back", tap_macro, (45, 30), 10),
        ("Back", tap_macro, (45, 30), 15),

        ("Campaign", tap_macro, (1130, 655), 15),
        ("2-1", tap_macro, (226, 387), 5),
        ("Fight", tap_macro, (1055, 675), 10),
        ("Archer", tap_macro, (700, 475), 5),
        ("New Archer", tap_macro, (270, 150), 10),
        ("Start", tap_macro, (1145, 585), 10),
        ("Skip", tap_macro, (1210, 50), 8),
        ("Tank", swipe_macro, (1100, 660, 323, 455),3),
        ("Swipe", swipe_macro, (323, 455, 600, 450), 3),
        ("2x", tap_macro, (1160, 40), 8),
        ("Healer", swipe_macro, (1100, 660, 356, 256),3),
        ("Swipe", swipe_macro, (356, 256, 330, 486), 3),
        ("Mage", swipe_macro, (1220, 645, 706, 345),3),
        ("Swipe", swipe_macro, (323, 455, 330, 344), 3),
        ("Archer", swipe_macro, (1220, 645, 573, 434),3),
        ("Swipe", swipe_macro, (573, 434, 583, 216), 80),
        ("Next", tap_macro, (1130, 655), 5),
        ("Continue", tap_macro, (1130, 655), 10),

        ("2-2", tap_macro, (340, 295), 5),
        ("Fight", tap_macro, (1055, 675), 10),
        ("Start", tap_macro, (1145, 585), 15),
        ("Tank", swipe_macro, (1100, 660, 1031, 477), 3),
        ("Swipe", swipe_macro, (1031, 477, 972, 252), 3),
        ("2x", tap_macro, (1160, 40), 3),
        ("Healer", swipe_macro, (1100, 660, 950, 222), 3),
        ("Swipe", swipe_macro, (950, 222, 1031, 477), 3),
        ("Mage", swipe_macro, (1220, 645, 1080, 289), 3),
        ("Swipe", swipe_macro, (1080, 289, 763, 290), 80),
        ("Global", tap_macro, (0, 0), 5),
        ("Camp", tap_macro, (273, 662), 15),

        ("Raid", tap_macro, (1202, 507), 10),
        ("Promotion Raid", tap_macro, (375, 300), 10),
        ("Go", tap_macro, (975, 170), 10),
        ("Fight", tap_macro, (1065, 650), 5),
        ("Start", tap_macro, (1145, 585), 10),
        ("MM", swipe_macro, (850, 666, 640, 144), 3),
        ("Swipe", swipe_macro, (640, 144, 940, 144), 10),
        ("Global", tap_macro, (0, 0), 10),
        ("Global", tap_macro, (0, 0), 10),
        ("Global", tap_macro, (0, 0), 9),
        ("Mage", swipe_macro, (1220, 645, 253, 344), 3),
        ("Swipe", swipe_macro, (253, 344, 653, 344), 5),
        ("2x", tap_macro, (1160, 40), 60),

        ("Global", tap_macro, (0, 0), 10),
        ("Global", tap_macro, (0, 0), 10),
        ("Hero", tap_macro, (170, 655), 15),
        ("Hero", tap_macro, (160, 180), 8),
        ("Promotion", tap_macro, (1220, 147), 10),
        ("Promote", tap_macro, (995, 630), 10),
        ("Promote", tap_macro, (995, 630), 20),
        ("Okay", tap_macro, (1075, 660), 5),
        ("Okay", tap_macro, (1075, 660), 5),
        ("Back", tap_macro, (45, 30), 15),
        ...
        ("2-3", tap_macro, (530, 370), 5),
        ("Fight", tap_macro, (1065, 650), 5),
        ("Start", tap_macro, (1145, 585), 10),
        ("Tank", swipe_macro, (1100, 660, 870, 360), 3),
        ("Swipe", swipe_macro, (870, 360, 870, 60), 3),
        ("2x", tap_macro, (1160, 40), 5),
        ("Healer", swipe_macro, (1100, 660, 1010, 443), 3),
        ("Swipe", swipe_macro, (1010, 443, 710, 443), 8),
        ("Mage", swipe_macro, (1220, 645, 766, 440), 3),
        ("Swipe", swipe_macro, (766, 440, 766, 140), 70),
        ("Continue", tap_macro, (1130, 655), 10),
        ("Continue", tap_macro, (1130, 655), 10),

        ("2-4", tap_macro, (528, 438), 5),
        ("Fight", tap_macro, (1065, 650), 5),
        ("Start", tap_macro, (1145, 585), 15),
        ("Global", tap_macro, (0,0), 8),
        ("Global", tap_macro, (0,0), 8),
        ("Global", tap_macro, (0,0), 8),
        ("Tank", swipe_macro, (1100, 660, 170, 481), 3),
        ("Swipe", swipe_macro, (170, 481, 470, 481), 3),
        ("2x", tap_macro, (1160, 40), 5),
        ("Healer",swipe_macro, (1100, 660, 330, 372), 3),
        ("Swipe", swipe_macro, (330, 372, 330, 672), 8),
        ("Mage", swipe_macro, (1220, 645, 420, 598), 3),
        ("Swipe", swipe_macro, (420, 598, 420, 298), 80),
        ("Complete", tap_macro, (1130, 655), 15),

        ("2-5", tap_macro, (530, 420), 5),
        ("Fight", tap_macro, (1065, 650), 5),
        ("Start", tap_macro, (1145, 585), 25),
        ("Tank", swipe_macro, (1100, 660, 259, 297), 3),
        ("Swipe", swipe_macro, (259, 297, 559, 297), 15),
        ("Healer", swipe_macro, (1100, 660, 327, 477), 3),
        ("Swipe", swipe_macro, (327, 477, 327, 177), 3),
        ("2x", tap_macro, (1160, 40), 12),
        ("Mage", swipe_macro, (1220, 645, 587, 291), 3),
        ("Swipe", swipe_macro, (587, 291, 187, 291), 70),
        ("Next", tap_macro, (1160, 40), 5),
        ("Global", tap_macro, (0, 0), 5),
        ("Continue", tap_macro, (1130, 655), 15),
        ("Global", tap_macro, (0, 0), 5),

        ("EXP", tap_macro, (527, 329), 5),
        ("Fight", tap_macro, (1065, 650), 5),
        ("Start", tap_macro, (1145, 585), 15),
        ("Tank", swipe_macro, (1100, 660, 270, 309), 3),
        ("Swipe", swipe_macro, (270, 309, 570, 309), 3),
        ("2x", tap_macro, (1160, 40), 3),
        ("Healer", swipe_macro, (1100, 660, 352, 400), 3),
        ("Swipe", swipe_macro, (352, 400, 352, 200), 8),
        ("Mage", swipe_macro, (1220, 645, 467, 508), 3),
        ("Swipe", swipe_macro, (467, 508, 467, 208), 190),
        ("Next", tap_macro, (1130, 655), 5),
        ("Complete", tap_macro, (1130, 655), 15)
    ]
